...
/*   Updated: 2017/10/05 11:43:58 by amoinier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->notDead()) {
		std::cout << "CLAPTRAP: " << this->name << " user his range weapons on " << target << ", he loose " << this->rangedAttackDamage << " hit points !" << std::endl;
	}
	else {
		std::cout << "CLAPTRAP: is dead, what are you doing ?" << std::endl;
	}
...
{
	if (this->notDead()) {
		std::cout << "CLAPTRAP: " << this->name << " user his melee weapons on " << target << ", he loose " << this->rangedAttackDamage << " hit points !" << std::endl;
	}
	else {
		std::cout << "CLAPTRAP: is dead, what vare you doing ?" << std::endl;
	}
