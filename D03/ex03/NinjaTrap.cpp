...
/*   Updated: 2017/10/05 15:33:25 by amoinier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->notDead()) {
			std::cout << "NINJ4-TP try to sneak " << trap.getName() << " but he is so clever !" << std::endl;
...
{
	if (this->notDead()) {
			std::cout << "NINJ4-TP attacks " << trap.getName() <<  " with an critical hit !" << std::endl;
			this->meleeAttack(trap.getName());
	}
	else {
		std::cout << "Of course, its a NINJ4-TP but it's not invincible ..." << std::endl;
...
{
	if (this->notDead()) {
			std::cout << "After 5 seconds, NINJ4-TP hit " << trap.getName() << "." << std::endl;
